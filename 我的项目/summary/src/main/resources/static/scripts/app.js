...
var App = function () {
    ...
    var handleDropdowns = function () {
        /*
          For touch supported literature disable the
    ...
    var handleTheme = function () {
        ...
        var sidebarPosOption = cookie('sidebarPosOption');
        ...
        if(footerOption == null) {
            footerOption = "default";
        }
        $('.footer-option', panel).val(footerOption);

        //if ( $('.sidebar-pos-option').attr("disabled") === false) {
        if(sidebarPosOption == null) {
            sidebarPosOption = App.isRTL() ? 'right' : 'left';
        }
        ...
        var setLayout = function () {
            ...
            cookie('layoutOption', layoutOption, {expires: 365, path: '/'});
            cookie('sidebarOption', sidebarOption, {expires: 365, path: '/'});
            cookie('headerOption', headerOption, {expires: 365, path: '/'});
            cookie('footerOption', footerOption, {expires: 365, path: '/'});
            cookie('sidebarPosOption', sidebarPosOption, {expires: 365, path: '/'});
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", ctxStatic+"/css/themes/" + color_ + ".css");
        }
        ...
        $('.theme-colors > ul > li', panel).click(function () {
            ...
            cookie("theme-color", color, {expires: 365, path: '/'});
            setColor(color);
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img src="'+ctxStatic+'/img/loading-spinner-grey.gif" align=""></div>';
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img src="'+ctxStatic+'/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : '努力加载中...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src='+ctxStatic+'"/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : '努力加载中...') + '</span></div>');
        },
